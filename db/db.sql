...
CREATE TABLE IF NOT EXISTS `itplus`.`program` (
  ...
  COMMENT '项目状态：100=未立项，110=立项，120=Demo评审，130=招投标申请，140=中标申请，150=产品评审，160=开发评审，170=测试评审，180=上线计划，190=灰度发布，195=灰度发布，200=延期上线，210=需求变更，900=完成，999=终止',
...
CREATE TABLE IF NOT EXISTS `itplus`.`program_change_log` (
  ...
  COMMENT '项目id',
  `program_status`      INT             NOT NULL
  COMMENT '项目状态：100=未立项，110=立项，120=Demo评审，130=招投标申请，140=中标申请，150=产品评审，160=开发评审，170=测试评审，180=上线计划，190=灰度发布，195=项目复盘，200=延期上线，210=需求变更，900=完成，999=终止',
  `action_change_info`  VARCHAR(500)    NULL
  COMMENT '日志信息',
  `modified_account_id` VARCHAR(50)     NULL
  COMMENT '最后修改人账户id',
